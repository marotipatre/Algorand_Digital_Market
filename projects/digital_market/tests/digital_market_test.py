...
from smart_contracts.artifacts.digital_market.digital_market_client import (
     DigitalMarketClient as DigitalMarketplaceClient,
)
...
def test_delete_application(
    ...
    # 200_000 for the MBR ALGO in the app that gets unlocked by opting out and closing the account // this is for the fees we paid for the fees which is 0.1 Algo
    # -3_000 for the fees
