...
export function create(
  ...
  dmFactory: DigitalMarketFactory,
  dmClient: DigitalMarketClient,
  ...
  return async () => {
    ...
    const result = await dmFactory.send.create.createApplication({ args: [assetId, unitaryPrice] })

    console.log(result.appClient.appId)
